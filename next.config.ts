...
const nextConfig: NextConfig = {
  experimental: {
    // @ts-ignore - This is needed for Next.js 16 (Turbopack) to resolve the correct root in some environments
    turbopack: {
      root: "/Users/paulo/.gemini/antigravity/playground/resonant-belt"
    }
  },
  async headers() {
    return [
