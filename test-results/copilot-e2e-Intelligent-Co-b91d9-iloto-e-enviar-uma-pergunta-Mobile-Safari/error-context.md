...
- Name: copilot-e2e.spec.ts >> Intelligent Copilot E2E >> Deve abrir o copiloto e enviar uma pergunta
- Location: tests/copilot-e2e.spec.ts:16:7
...
Locator: getByText('Sou seu copiloto financeiro inteligente')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Sou seu copiloto financeiro inteligente')
