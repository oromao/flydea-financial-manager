    ...
    <div className="space-y-8 max-w-6xl mx-auto pb-20 md:pb-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {shortcuts.map((item) => {
          ...
          return (
            <Card key={item.href} className="premium-card p-5">
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <Link
                    href={item.href}
                    className="inline-flex items-center justify-center mt-4 rounded-xl h-10 px-4 bg-primary text-primary-foreground font-medium transition-colors hover:bg-primary/90"
                  >
                    Abrir
