...
| QA-02 Dropdown UUID | ✅ Fix aplicado (SelectValue c/ children) |
...
| AN1-T6 Link /import quebrado | ✅ empty-states.tsx href="/import" → href="/movimentacoes" (E16-T6) |
| AN2-T1 Zod validation | 🔶 Sprint 4: 22/48 APIs (45.8%, target 100%) |
| AN2-T2 Rate limiting | ✅ 44/44 APIs (100%) |
| AN3-T3 Error boundaries | ✅ 14 páginas com PageErrorBoundary |
| AN3-T1 any types | 🔶 Sprint 4: 31 remanescentes |
| AN1-T4 confirm() nativo | ✅ Verificado: zero ocorrências (E2-T1 já resolveu) |
| AL-01 markAllRead batch | ✅ N paralelas → batch único |
| FLY-024 Archive contas | ✅ Implementado completo |
| AU-02 UUID Editar Lançamento | ✅ Fix aplicado (SelectValue children) |
| QA-08 Date ISO | ✅ Fix E16-T3 — helpers `formatDateToBR`/`formatDateToISO` aplicados a 6 arquivos |
| AU-04 Typos | ✅ Corrigido no Sprint 3 (E15-T4..T6) |
| AU-05 Insights duplicado | ✅ Corrigido (redirect → /relatorios) |
| AU-06 Sidebar scroll | ✅ Corrigido (whitespace-nowrap) |
| AU-07 Link Relatórios | ✅ Adicionado na sidebar |
